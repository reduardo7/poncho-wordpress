...
function simple_boostrap_theme_support() {
    ...
    register_nav_menus(                      // wp3+ menus
        array( 
            'main_nav' => __('Main Menu', 'poncho'),   // main nav in header
        )
    );
    add_image_size( 'simple_boostrap_featured', 1140, 1140 * (9 / 21), true);
    load_theme_textdomain( 'poncho', get_template_directory() . '/languages' );
}
...
function simple_boostrap_register_sidebars() {
    register_sidebar(array(
        'id' => 'sidebar-right',
        'name' => __('Right Sidebar', 'poncho'),
        'description' => __('Used on every page.', 'poncho'),
    ...
    <ul class="meta text-muted list-inline">
        ...
        <li>
            <?php
                ...
                comments_popup_link($sp . __( 'Leave a comment', "poncho"), $sp . __( '1 Comment', "poncho"), $sp . __( '% Comments', "poncho"));
            ?>
        </li>
        <?php endif; ?>
        <?php edit_post_link(__( 'Edit', "poncho"), '<li><span class="glyphicon glyphicon-pencil"></span> ', '</li>'); ?>
    </ul>
    ...
    <?php if (get_next_posts_link() || get_previous_posts_link()) { ?>
        <nav class="block">
            <ul class="pager pager-unspaced">
                <li class="previous"><?php next_posts_link("&laquo; " . __('Older posts', "poncho")); ?></li>
                <li class="next"><?php previous_posts_link(__('Newer posts', "poncho") . " &rsquo;"); ?></li>
            </ul>
        </nav>
    <?php } ?>
