...
<div id="content" class="row">
	...
	<div id="main" class="<?php simple_boostrap_main_classes(); ?>" role="main">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class("block"); ?> role="article">
			...
			<nav>
			  	<ul class="pager">
			    	<li class="previous"><?php next_image_link( false, __( '&laquo; Previous', "poncho")); ?></li>
			    	<li class="next"><?php previous_image_link( false, __( 'Next &raquo;', "poncho")); ?></li>
			  	</ul>
			</nav>
		...
		<article id="post-not-found" class="block">
		    <p><?php _e("No items found.", "poncho"); ?></p>
		</article>
